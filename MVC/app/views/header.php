...
<body>
    <header>
        ...
        <div class="tena">
            <div class="zavatra" style="<?php if ($_GET['action'] == 'patisserie') {
                                            echo 'background-image: url(../../assets/img/bread-border-wood-background-copy-space-whole-grain-loaves-spikelets-different-types-bakery-vertical-composition-184929806.jpg)';
                                        } else if ($_GET['action'] == 'pain') {
                                            echo 'background-image: url(../../assets/img/contenu/_117644323_262c7b8f-a2d1-49ed-83af-2518a27760d7.jpg)';
                                        } else if ($_GET['action'] == 'cake') {
                                            echo 'background-image: url(../../assets/img/contenu/670508.jpg)';
                                        } else if ($_GET['action'] == 'viennoiserie') {
                                            echo 'background-image: url(../../assets/img/contenu/titre.jpg)';
                                        }
                                        ?>">
                <div class="objet">
                    <ul>
    ...
    <div class="corps">
        ...
        ?>
            <div class="produit">
                <div class="img">
                    <img src="../../assets/imgs/<?php echo $s->nom; ?>">
                </div>
                <div class="contenue">
                    <div class="propos">
                        <ul>
